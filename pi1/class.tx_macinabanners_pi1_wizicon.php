...
*  Copyright notice
*  
*  (c) 2004 Wolfgang Becker (wb@macina.com)
*  All rights reserved
*
...
class tx_macinabanners_pi1_wizicon {
	...
	function proc($wizardItems) {
		...
		$wizardItems["plugins_tx_macinabanners_pi1"] = array(
			"icon"=>t3lib_extMgm::extRelPath("macina_banners")."pi1/ce_wiz.gif",
			"title"=>$LANG->getLLL("pi1_title",$LL),
			"description"=>$LANG->getLLL("pi1_plus_wiz_description",$LL),
			"params"=>"&defVals[tt_content][CType]=list&defVals[tt_content][list_type]=macina_banners_pi1"
		);
